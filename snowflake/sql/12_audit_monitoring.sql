...
SELECT RUN_ID, PIPELINE_NAME, SOURCE_SYSTEM, START_TIME, END_TIME,
       STATUS, RECORDS_READ, RECORDS_PROCESSED, RECORDS_REJECTED,
       SOURCE_FILE, ERROR_CODE, ERROR_MESSAGE
